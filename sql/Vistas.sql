...
CREATE OR REPLACE VIEW "ADMIN"."VISTABUSQUEDASMODELOS" AS
SELECT u.NOMBRE AS Usuario, 
       b.MODELO AS Modelo_Buscado, 
       b.FECHABUSQUEDA AS Fecha_Busqueda
FROM "ADMIN"."BUSQUEDASMODELOS" b
JOIN "ADMIN"."USUARIO" u ON b.ID_USUARIO = u.IDUSUARIO
